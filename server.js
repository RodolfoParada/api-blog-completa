...
// Nota: Las rutas de comentarios se pueden montar a través de /api/posts si es necesario
// o directamente si la ruta base es /api/comments.
// Aquí asumimos que las rutas dentro de commentsRoutes comienzan con /comments o similar.
app.use('/api', commentsRoutes); 

// --- Documentación y Página de Inicio (se mantiene aquí por simplicidad) ---
app.get('/api/docs', (req, res) => {
  res.json({
    // ... Tu objeto OpenAPI completo ...
    openapi: '3.0.0',
    info: {
      title: 'API de Blog',
      version: '1.0.0',
